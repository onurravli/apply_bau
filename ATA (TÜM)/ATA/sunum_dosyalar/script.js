...
var ENDSHOW_MESG="Slayt gösterisi bitti, çýkmak için týklatýn.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=8, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gMainDoc=new Array(new hrefList("slide0001.htm",1,-1,1),new hrefList("slide0002.htm",1,-1,1),new hrefList("slide0009.htm",1,-1,1),new hrefList("slide0003.htm",1,-1,1),new hrefList("slide0004.htm",1,-1,1),new hrefList("slide0005.htm",1,-1,1),new hrefList("slide0006.htm",1,-1,1),new hrefList("slide0007.htm",1,-1,1));
...
var sNext="Sonraki",sPrev="Önceki",sEnd="Gösteriyi Bitir",sFont="Arial",sArrow="Ok",sFreeform="Serbest Form",sRect="Dikdörtgen",sOval="Oval"
function ShowMenu()
{
	BuildMenu();
